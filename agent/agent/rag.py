...
retriever = vector_store.as_retriever(search_kwargs={"k": RETRIEVER_K}) if vector_store else None
    ...
    try:
        ...
        for pattern in req_patterns:
            ...
            if match:
                ...
                req_type = 'requirement' if 'req' in pattern else 'testing' if 'test' in pattern else 'guidance'
...
5. Provide clear implementation guidance"""
        ...
        return response.text.strip() if response.text.strip() else "🤖 I need to think about this differently. Could you rephrase your question?"
